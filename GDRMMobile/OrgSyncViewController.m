...
- (void)viewDidLoad
{
    ...
    self.serviceTextField.placeholder = @"云梧";
}
...
-(void)setServiceTextDelegate:(NSString *)aText{
    ...
    if ([self.serviceTextField.text isEqualToString:@"广云"]) {
        self.textServerAddress.text = @"http://219.131.172.163:81/irmsdatagy/";
    }else
    {
        self.textServerAddress.text = @"http://219.131.172.163:81/irmsdata/";
    }
}
@end
